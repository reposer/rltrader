...
class Agent:
    ...
    def decide_trading_unit(self, confidence):
        ...
        added_trading = max(min(int(confidence * (self.max_trading_unit - self.min_trading_unit)), self.max_trading_unit
                                - self.min_trading_unit), 0)
    ...
    def act(self, action, confidence):
        ...
        if action == Agent.ACTION_BUY:
            ...
            if balance < 0:
                trading_unit = max(min(int(self.balance / (curr_price * (1 + self.TRADING_CHARGE))),
        ...
        return self.immediate_reward, delayed_reword
